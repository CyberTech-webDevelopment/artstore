			...
			<div class="mr-auto ml-auto col-lg-4 col-md-5 col-sm-6 d-flex footer-right flex-column justify-content-start text-center">
				<div class=" mb-4">
					...
					<div class="soc-icons d-flex text-center justify-content-center">
						<div class="linkdin ml-3 mr-3"><a href=""><img src="icons/linkedin.png"></i></a></div>
						<div class="instagram ml-3 mr-3 "><a href=""><img src="icons/instagram.png"></a></div>
						<div class="facebook ml-3 mr-3 "><a href=""><img src="icons/footer-facebook.png"></a></div>
					</div>
				</div>
				<div class="mt-4">
					...
					<form>
						...
						<input type="submit" name="" class="news-submit text-strong ml-2" value="Sign Up">
					</form>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-7 col-sm-6 footer-bottom-left d-flex pt-3 justify-content-around">
				...
				<div class=""><img src="images/cards/visa.png" alt="visa" title="visa"></div>
				<div class=""><img src="images/cards/MasterCard.png" alt="MasterCard" title="MasterCard"></div>
				<div class=""><img src="images/cards/paypal.png" alt="paypal" title="paypal"></div>
				<div class=""><img src="images/cards/amex.png" alt="amex" title="amex"></div>
				<div class=""><img src="images/cards/arca.png" alt="arca" title="arca"></div>
				<div class=""><img src="images/cards/qiwi.png" alt="qiwi" title="qiwi"></div>
				<div class=""><img src="images/cards/webmoney.png" alt="webmoney" title="webmoney"></div>
				<div class=""><img src="images/cards/idram.png" alt="idram" title="idram"></div>
	   ...
	   <div class="row ml-0 mr-0">
		<div class="d-flex justify-content-between">
            ...
            <div class="text-center pt-3 pl-3 pr-3 footer-social-icons">
            	<div class="text-strong tuch pb-3 mt-0">Get In Tuch</div>
					<div class="soc-icons d-flex text-center justify-content-center">
						<div class="linkdin ml-2 mr-2 "><a href=""><img src="icons/linkedin.png"></a></div>
        ...
        <div class="w-100 d-flex justify-content-between pl-0 pr-0 mt-5">
            ...
            <div class="w-100 mt-2">
				...
				<div class=" w-100 d-flex justify-content-between pr-0 mt-3">
					<div class="col-3 pl-0"><img src="images/cards/visa.png" alt="visa" title="visa"></div>
					<div class="col-3"><img src="images/cards/MasterCard.png" alt="MasterCard" title="MasterCard"></div>
					<div class="col-3"><img src="images/cards/paypal.png" alt="paypal" title="paypal"></div>
					<div class="col-3"><img src="images/cards/amex.png" alt="amex" title="amex"></div>
				</div>
				<div class="w-100 d-flex justify-content-between pr-0 mt-2">
					<div class="col-3 pl-0"><img src="images/cards/arca.png" alt="arca" title="arca"></div>
					<div class="col-3 "><img src="images/cards/qiwi.png" alt="qiwi" title="qiwi"></div>
					<div class="col-3 "><img src="images/cards/webmoney.png" alt="webmoney" title="webmoney"></div>
					<div class="col-3 "><img src="images/cards/idram.png" alt="idram" title="idram"></div>
				</div>
            </div>
