				...
				<div class="col-lg-6 col-md-10 col-sm-12 pl-0 pr-5 " id="img-cont">
					<div class=" pb-2">
						<div class="product-image-div">
							<span ><img src="icons/icon-new-arrival1.png"></span>
							<span class="pt-2"><img src="icons/vector-heart-wh.png"></span>
							<img src="images/andrijana1.png">
						</div>
					</div>
					<div class="carusel-cont" id="product-carousel-cont">
						<?php include "carusel/carusel-for-product.php"; ?>
					</div>
				</div>
				...
				<div class="col-lg-6 col-md-12 col-sm-12 text-strong pr-1 product-info">
					...
					<div class="d-flex seller-name">
						...
						<div class="ml-5 pl-2 pr-2 pb-0">
							<span class="pr-2"><img src="icons/icon-letter.png"></span>Contact Seller
						</div>
					</div>
					<div class="d-flex star-cont">
						<div class="mr-2"><img src="icons/vector-star-product.png"></div>
						<div class="mr-2"><img src="icons/vector-star-product.png"></div>
						<div class="mr-2"><img src="icons/vector-star-product.png"></div>
						<div class="mr-2"><img src="icons/vector-star-tr-product.png"></div>
						<div class="mr-2"><img src="icons/vector-star-tr-product.png"></div>
								...
								<div class="d-flex flex-wrap">
								    ...
								    <div class="col-xl-6 col-lg-12 text-strong">
								    	...
								    	<div class="d-flex pt-3">
								    		<div><img src="images/cards/visa.png"></div>
								    		<div><img src="images/cards/MasterCard.png"></div>
								    		<div><img src="images/cards/paypal.png"></div>
								    		<div><img src="images/cards/visa.png"></div>
								    		<div><img src="images/cards/MasterCard.png"></div>
								    	</div>
								    </div>
...
<div class="product-details-cont" id="product-details-cont2">
 <div class="accordion" id="accordionExample">
  ...
  <div class="card">
							...
							<div class="transparent-div">
								<div class="d-flex transparent-div ">
									<div class="d-flex align-items-center justify-content-center">
										<div><img src="icons/vector-search-wh.png"></div>
										<div><img src="icons/vector-heart-wh.png"></div>
									</div>
								</div>
							</div>
							<img src="images/andrijana3.png">
						</div>
						<div>
							<div class="transparent-div">
								<div class="d-flex transparent-div">
    ...
    <script src="carusel/js/main-for-product.js"></script>
