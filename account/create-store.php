<div class="create-store-container ml-1 pb-5">
	...
	<div class="row pr-0"> 
		...
		<div class="form-group parent">
			<div class="d-flex">
				...
				<div class="ml-2">
					<img src="icons/edit-account-settings.png">
					<div></div>
	...
	<div class="row pr-0"> 
		...
		<div class="form-group parent col-12 pl-0 pr-0">
			<div class="d-flex">
				<div class="drag-photo pt-4">
					<div class="text-center pb-2"><img src="icons/upload.png"></div>
					<div class="font-size-12 text-center">Drag photo to upload</div>
					<div class="font-size-12 text-center">or</div>
					<div class="text-center"><label class="browse font-size-12 text-strong"><input type='file'>Browse</label></div>
				</div>
		...
		<div >
			...
			<div class="hide-style" id="store-style">
				<div class="d-flex flex-wrap justify-content-between pt-4 style-group-cont">
					<div class="d-flex">
						<div><img src="images/style-group1.png" class="style-group-img"></div>
						<div><input type="checkbox" name=""></div>
					</div>
					<div class="d-flex">
						<div><img src="images/style-group2.png" class="style-group-img"></div>
						<div><input type="checkbox" name=""></div>
					</div>
					<div class="d-flex">
						<div><img src="images/style-group3.png" class="style-group-img"></div>
						<div><input type="checkbox" name=""></div>
					</div>
				</div>
			</div>
	...
	<div class="row pt-3 pb-5">
		<button class="create-store-btn" type="button" data-toggle="modal" data-target="#centered">Create Store</button>
	</div>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body pt-3 pb-3">
          <div class="text-center"><img src="icons/success.png"></div>
