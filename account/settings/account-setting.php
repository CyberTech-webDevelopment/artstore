<div class="row account-settings  pl-4  pr-4">
	...
	<div class="avatar">
		...
		<img src="images/users-image/1.png">
	</div>
	<div class="pl-5">
		  ...
		  <div class="form-group parent col-7 mt-4">
		  	<form>
	         		<div class="">
					    ...
					    <div class="d-flex">
					       <input type="text" disabled="true" class="form-control account-change-inp " id="account-change-name" min="6" max="29" data-name='0' placeholder="Username">
				           <div class="pl-2 mt-1"><img src="icons/edit-account-settings.png"></div>
				        </div>
				    </div>
				    <div class="form-group parent mb-0">
					  	<div>
						    ...
						    <div class="d-flex">
						       <input type="email" disabled="true" class="form-control account-change-inp" id="account-change-mail" data-name='0' placeholder="e-mail">
					           <div class="pl-2 mt-1"><img src="icons/edit-account-settings.png"></div>
				            </div>
					    </div>
				     ...
				     <div class="input-group">
						    <input type="password" disabled="true" class="form-control account-change-inp" id="account-change-pass" min="8" max="16" data-name='0'>
						    <div class="pl-2 mt-1"><img src="icons/edit-account-settings.png"></div>
				     </div>
