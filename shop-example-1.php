<?php include "header.php"; ?>
  ...
  <link rel="stylesheet" href="css/shop-example-1.css" > 
  ...
  <body>
	...
	<section class="container-fluid container-mobile-menu">
       <div class="row">
       	  <div class="d-flex flex-wrap baner" style="background: url('images/baners/baner-1.png')">
       	  	 <div class=" d-flex flex-wrap flex-column  align-self-end baner-container w-100">
	       	  	  <div class=" ml-4 h-100 align-self-stretch bd-highlight">
	       	  	  	  <div class="  user-avatar-div" style="background: url('images/users-image/1.png'); background-size: cover;
	       	  	  ...
	       	  	  <div class="h-50 bd-highlight white-starts-cont">
	       	  	  	  ...
	       	  	  	  <div class="d-flex">
		   	  				...
		   	  				<span class="pr-2"><img src="icons/white-trs-star.png"></span>
                            <div class="pr-2 pl-2 bg-white contact-seller text-strong"><span class="pr-2"><img src="icons/icon-letter.png"></span>Contact <span class="hidden-span">Seller</span></div>
	       	  	  	  </div>
	       	  	  	  <div>
		    	...
		    	<div class="row d-flex flex-nowrap nowrap-cont justify-content-center pr-0 pl-4 mr-0 pt-3">
		   	  				...
		   	  				<div >
			   	  				...
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					...
			   	  					<div class="pordz" style='background: url(images/andrijana1.png); background-size: cover'></div>
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 br-1 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<div class="pordz" style='background: url(images/andrijana2.png); background-size: cover'></div>
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 br-1 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					...
			   	  					<div class="pordz" style='background: url(images/andrijana3.png); background-size: cover'></div>
			   	  				    <div class="icon-new-arrival">
			   	  						<img src="icons/icon-new-arrival.png">
			   	  					</div>
			   	  					<div class="width-inherit pl-0 pr-0 hover-icons d-flex align-items-center bd-highlight">
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 br-1 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					...
			   	  					<div class="pordz" style='background: url(images/andrijana4.png); background-size: cover'></div>
			   	  				    <div class="icon-new-arrival">
			   	  						<img src="icons/icon-new-arrival.png">
			   	  					</div>
			   	  					<div class="width-inherit pl-0 pr-0 hover-icons d-flex align-items-center bd-highlight">
		    	...
		    	<div class="scroll-cont">
		    	   <div class="row d-flex flex-nowrap nowrap-cont justify-content-center pr-0 pl-4 mr-0 pt-3">
		   	  				...
		   	  				<div >
			   	  				...
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<!-- <img src="images/andrijana1.png" class="img-fluid ps-abs-image"> -->
			   	  					<div class="pordz" style='background: url(images/ho1.png); background-size: cover'></div>
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 br-1 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<div class="pordz" style='background: url(images/ho2.png); background-size: cover'></div>
			   	  					<!-- <img src="images/andrijana2.png" class="ps-abs-image"> -->
			   	  				    <div class="icon-hot hot ">
			   	  						<img src="icons/hot.png">
			   	  					</div>
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 br-1 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<!-- <img src="images/andrijana3.png" class="ps-abs-image"> -->
			   	  					<div class="pordz" style='background: url(images/ho3.png); background-size: cover'></div>
			   	  				    <div class="icon-hot hot ">
			   	  						<img src="icons/hot.png">
			   	  					</div>
			   	  					<div class="width-inherit pl-0 pr-0 hover-icons d-flex align-items-center bd-highlight">
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 br-1 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<!-- <img src="images/andrijana4.png" class="ps-abs-image"> -->
			   	  					<div class="pordz" style='background: url(images/ho4.png); background-size: cover'></div>
			   	  				    <div class="icon-hot hot ">
			   	  						<img src="icons/hot.png">
			   	  					</div>
			   	  					<div class="width-inherit pl-0 pr-0 hover-icons d-flex align-items-center bd-highlight">
		    	...
		    	<div class="scroll-cont">
		    	  <div class="row d-flex flex-nowrap nowrap-cont justify-content-center pr-0 pl-4 mr-0 pt-3">
		   	  				...
		   	  				<div >
			   	  				...
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<!-- <img src="images/andrijana1.png" class="img-fluid ps-abs-image"> -->
			   	  					<div class="pordz" style='background: url(images/seller1.png); background-size: cover'></div>
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 br-1 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<div class="pordz" style='background: url(images/seller4.png); background-size: cover'></div>
			   	  					<!-- <img src="images/andrijana2.png" class="ps-abs-image"> -->
			   	  				    <div class="icon-bestseller bestseller">
			   	  						<img src="icons/bestseller.png">
			   	  					</div>
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 br-1 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<!-- <img src="images/andrijana3.png" class="ps-abs-image"> -->
			   	  					<div class="pordz" style='background: url(images/seller2.png); background-size: cover'></div>
			   	  				    <div class="icon-bestseller bestseller">
			   	  						<img src="icons/bestseller.png">
			   	  					</div>
			   	  					<div class="width-inherit pl-0 pr-0 hover-icons d-flex align-items-center bd-highlight">
		   	  			...
		   	  			<div class="col-xl-2 col-lg-2 col-md-3 col-sm-5 col-xs-5 br-1 right-div-item">
		   	  				<div >
			   	  				<div class="transparent-bg-div d-flex" >
			   	  					<!-- <img src="images/andrijana4.png" class="ps-abs-image"> -->
			   	  					<div class="pordz" style='background: url(images/seller3.png); background-size: cover'></div>
			   	  				    <div class="icon-bestseller bestseller">
			   	  						<img src="icons/bestseller.png">
			   	  					</div>
			   	  					<div class="width-inherit pl-0 pr-0 hover-icons d-flex align-items-center bd-highlight">
			...
			<div class="d-flex flex-wrap sort-by-divs justify-content-center">
						<div class="br-1 pr-3 pl-3">
							<div class="transparent-bg-div d-flex" >
			   	  					...
			   	  					<div class="pordz" style='background: url(images/ts-product1.png); background-size: cover'></div>
			   	  					<div class="width-inherit pl-0 pr-0 hover-icons d-flex align-items-center bd-highlight">
			   	  						<div class="w-100 div-icons d-flex justify-content-center align-self-center bd-highlight">
					   	  						<span class=""><img src="icons/vector-search-wh.png"></span>
					   	  						<span class="ml-3 "><img src="icons/vector-heart-wh.png"></span>
