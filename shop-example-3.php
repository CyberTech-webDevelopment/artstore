<?php include "header.php"; ?>
  ...
  <link rel="stylesheet" href="carusel/css/shop-3.css" >
  <!-- <link rel="stylesheet" href="css/sections.css"> -->
  <link rel="stylesheet" href="css/shop-example-3.css" > 
       	  	 	...
       	  	 	<div class="d-flex align-items-center anim-div ">
	       	  	  ...
	       	  	  <div class="flex-column h-100 pr-3 align-items-end justify-content-end banner-right-div">
	       	  	  	  ...
	       	  	  	  <div class="pb-3 d-flex social-icons align-self-end justify-content-end">
	       	  	  	 	<div><a href="" class="text-white"><img src="icons/share.png" class="share"><span id="share">Share<span></a></div>
...
<!-- -----------------------------section new-arrivals--------------------------------------------------- -->
		...
		<?php include "carusel/carousel-shop-3-arrivals.php"; ?>
		<?php include "carusel/carousel-shop-3-hot.php"; ?>
		<?php include "carusel/carousel-shop-3-bestsellers.php"; ?>
...
<!-- --------------------------------------sort by-------------------------------------- -->
    ...
    <script src='carusel/js/main-shop-3.js'></script>
    <script>
    	$('.caret-left').hide()
