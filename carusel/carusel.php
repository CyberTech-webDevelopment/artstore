                                     ...
                                     <div class="transparent-div">
                                          <div class=" d-flex bd-highlight">
                                            <div class="row-icon-div align-self-center bd-highlight">
                                              <div class="text-capitalize text-center text-strong">body care</div>
                                              <div ><img class="m-auto " src="icons/vector-heart-wh.png"></div>
                                            </div>
                                          </div>
                                     </div>
                                     <img src="carusel/img/ecopanda.png"> 
                                </div>
                             </div>
                        </div>
                    </div>
                            ...
                            <div class="collect-card carusel-card">
                              <div class="img-card">
                                <div class="transparent-div">
                                  ...
                                  <img src="carusel/img/foto-phanatic.png"> 
                              </div>
                            </div>
                        </div>
                    </div>
                          ...
                          <div class="collect-card carusel-card">
                               <div class="img-card">
                                <div class="transparent-div">
                                   ...
                                   <img src="carusel/img/freestocks.png"> 
                               </div>
                          </div>
                        </div>
                    </div>
                             ...
                             <div class="collect-card carusel-card">
                                 <div class="img-card">
                                  <div class="transparent-div">
                                    ...
                                    <img src="carusel/img/jason-blackeye.png"> 
                                </div>
                             </div>
                         </div>
                  </div>
                             ...
                             <div class="collect-card carusel-card">
                                  <div class="img-card">
                                    <div class="transparent-div">
                                      ...
                                      <img src="carusel/img/luke-lung.png"> 
                                  </div>
                            </div>
                        </div>
                  </div>
                             ...
                             <div class="collect-card carusel-card">
                                 <div class="img-card">
                                  <div class="transparent-div">
                                     ...
                                     <img src="carusel/img/maria-ilves.png"> 
                                 </div>
                             </div>
                        </div>
                  </div>
