    ...
    <div class="modal-content">
      	...
      	<div>
				  ...
				  <div class="form-group parent">
				     ...
				     <div class="input-group">
						    <input type="password" class="form-control log-inp" id="log-pass" class="password" min="8" max="16" data-name='0'>
				     ...
				     <small id="forgot-password" class="form-text text-right" data-toggle="modal" data-target="#forgotPassword" data-dismiss="modal" aria-label="Close">Forgot your password?</small>
				  </div>
				   <div class="custom-control custom-checkbox my-1 mr-sm-2">
					    <input type="checkbox" class="custom-control-input" id="remember-inp">
					    <label class="custom-control-label text-strong" for="remember-inp" id="remember">Remember me </label>
					</div>
      ...
      <div class="modal-footer">
	      <div class="text-center footer-div">
	      	...
	      	<button type="button" id="sign-up" class="btn pl-3 pt-1 sign-up text-strong close" data-toggle="modal" data-target="#signUp" data-dismiss="modal" aria-label="Close">
                             SIGN UP
            </button>
	      </div>
      </div>
